...
import { EtaBlotMarcaAlteracao } from './eta-blot-marca-alteracao';
...
import { EtaContainerTdMarcaAlteracao } from './eta-container-td-marca-alteracao';
...
export class EtaQuill extends Quill {
  ...
  static configurar(): void {
    ...
    EtaQuill.register(EtaBlotMarcaAlteracao, true);
    EtaQuill.register(EtaContainerTdMarcaAlteracao, true);
