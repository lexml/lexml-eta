 ...
 */ if (itemMenu === renumerarElementoAction) {
  ...
  private getIconRevisao(elemento: Elemento): string {
    return `<svg xmlns="http://www.w3.org/2000/svg" id="svg_revisao${elemento.uuid}" width="20" height="20" viewBox="0 0 24 24" fill="none">
