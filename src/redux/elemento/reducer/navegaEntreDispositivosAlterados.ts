...
import { getDispositivoAnteriorNaSequenciaDeLeitura, getDispositivoPosteriorNaSequenciaDeLeitura } from '../../../model/lexml/hierarquia/hierarquiaUtil';
...
const isAlterado = (d: Dispositivo, revisoes: RevisaoElemento[]): boolean => {
  return !isArticulacao(d) && !!findRevisaoByElementoUuid(revisoes, d.uuid!);
};
