...
**LexML-ETA** (Editor de Texto Articulado - Legislative Text Editor) is a web component-based application for editing structured legislative documents (articulated legal texts) for the Brazilian Senate. It provides structured editing of legal texts with support for LexML format.
