export const PLC_142_2028 = {
  ...
  value: {
    ...
    metadado: { TYPE_NAME: 'br_gov_lexml__1.Metadado', identificacao: { TYPE_NAME: 'br_gov_lexml__1.Identificacao', urn: 'urn:lex:br:senado.federal:projeto.lei;pl:2018;142' } },
    projetoNorma: {
      ...
      norma: {
        ...
        parteInicial: {
          ...
          epigrafe: { TYPE_NAME: 'br_gov_lexml__1.GenInline', id: 'epigrafe', content: ['PROJETO DE LEI Nº 142 DE 2018'] },
          ementa: {
            TYPE_NAME: 'br_gov_lexml__1.GenInline',
            id: 'ementa',
            content: [
              'Institui a Política de Inovação Educação Conectada; e altera a ',
              {
                name: {
                ...
                value: { TYPE_NAME: 'br_gov_lexml__1.GenInline', href: 'urn:lex:br:federal:lei:2000-08-17;9998', content: ['Lei nº 9.998, de 17 de agosto de 2000'] },
              },
              '.',
            ],
          },
                      ...
                      p: [
                        {
                          TYPE_NAME: 'br_gov_lexml__1.GenInline',
                          content: [
                            '\n    Fica instituída a Política de Inovação Educação Conectada, em consonância com a estratégia 7.15 do Plano Nacional de Educação, aprovado pela ',
                            {
                              name: {
                                namespaceURI: 'http://www.lexml.gov.br/1.0',
                                localPart: 'span',
                              ...
                              value: {
                                TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                href: 'urn:lex:br:federal:lei:2014-06-25;13005',
                                content: ['Lei nº 13.005, de 25 de junho de 2014'],
                              },
                            },
                            ', com o objetivo de apoiar a universalização do acesso à internet em alta velocidade e fomentar o uso pedagógico de tecnologias digitais na educação básica.\n  ',
                          ],
                        },
                      ],
                    },
                      ...
                      p: [
                        {
                          TYPE_NAME: 'br_gov_lexml__1.GenInline',
                          content: [
                            '\n    A Política de Inovação Educação Conectada visa a conjugar esforços entre órgãos e entidades da União, dos Estados, do Distrito Federal, dos Municípios, escolas, setor empresarial e sociedade civil para assegurar as condições necessárias à inserção da tecnologia como ferramenta pedagógica de uso cotidiano nas escolas públicas de educação básica.\n  ',
                          ],
                        },
                      ],
                    },
                        ...
                        },
                        {
                          ...
                          value: {
                            ...
                            p: [
                              {
                                TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                content: ['\n    oferta de cursos de formação de profissionais da educação para apoiar a implementação da Política;\n  '],
                              },
                            ],
                          },
                        },
                            ...
                            p: [
                              {
                                TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                content: [
                                  '\n    disponibilização de materiais pedagógicos digitais gratuitos, preferencialmente abertos, de domínio público e licença livre, que contem com a efetiva participação de profissionais da educação em sua elaboração;\n  ',
                                ],
                              },
                            ],
                          },
                            ...
                            p: [
                              {
                                TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                content: [
                                  '\n    os Estados, o Distrito Federal e os Municípios, nos termos da ',
                                  {
                                    name: {
                                      namespaceURI: 'http://www.lexml.gov.br/1.0',
                                      localPart: 'span',
                                    ...
                                    value: {
                                      TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                      href: 'urn:lex:br:federal:lei:2012-07-25;12695',
                                      content: ['Lei nº 12.695, de 25 de julho de 2012'],
                                    },
                                  },
                                  '; e\n  ',
                                ],
                            ...
                            p: [
                              {
                                ...
                                content: [
                                  '\n    as escolas, nos termos da ',
                                  {
                                    ...
                                    value: {
                                      TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                      href: 'urn:lex:br:federal:lei:2009-06-16;11947',
                                      content: ['Lei nº 11.947, de 16 de junho de 2009'],
                                    },
                                  },
                                  '.\n  ',
                                ],
                ...
                lXcontainersOmissis: [
                  {
                    ...
                    value: {
                      ...
                      p: [
                        {
                          ...
                          content: [
                            '\n    Os ',
                            {
                              ...
                              value: { TYPE_NAME: 'br_gov_lexml__1.GenInline', href: 'urn:lex:br:federal:lei:2000-08-17;9998!art1', content: ['arts. 1º'] },
                            },
                            ' e ',
                            {
                              name: {
                              ...
                              value: {
                                TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                href: 'urn:lex:br:federal:lei:2000-08-17;9998!art5',
                                content: ['5º da Lei nº 9.998, de 17 de agosto de 2000'],
                              },
                            },
                      ...
                      alteracao: {
                        ...
                        base: 'urn:lex:br:federal:lei:2000-08-17;9998',
                        id: 'art13_cpt_alt1',
                        content: [
                          {
                            name: {
                                    ...
                                    p: [
                                      {
                                        TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                        content: [
                                          '\n    Fica instituído o Fundo de Universalização dos Serviços de Telecomunicações (Fust), que tem por finalidade proporcionar recursos destinados a cobrir a parcela de custo exclusivamente atribuível ao cumprimento das obrigações de universalização de serviços de telecomunicações, que não possa ser recuperada com a exploração eficiente do serviço, nos termos do ',
                                          {
                                            name: {
                                              namespaceURI: 'http://www.lexml.gov.br/1.0',
                                              localPart: 'span',
                                            ...
                                            value: {
                                              TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                              href: 'urn:lex:br:federal:lei:1997-07-16;9472!art81_cpt_inc2',
                                              content: ['inciso II do caput do art. 81 da Lei nº 9.472, de 16 de julho de 1997'],
                                            },
                                          },
                                          ', e a cobrir as despesas de programas, projetos e atividades governamentais direcionados à política de inovação educação conectada.\n  ',
                                        ],
                                      },
                                    ],
                                  },
                                    ...
                                    lXcontainersOmissis: [
                                      {
                                        ...
                                        value: { TYPE_NAME: 'br_gov_lexml__1.Omissis', id: 'art13_cpt_alt1_art5_cpt_omi1' },
                                      },
                                      {
                                        name: {
                                          namespaceURI: 'http://www.lexml.gov.br/1.0',
                                        ...
                                        value: {
                                          TYPE_NAME: 'br_gov_lexml__1.DispositivoType',
                                          href: 'art5_cpt_inc15',
                                          id: 'art13_cpt_alt1_art5_cpt_inc15',
                                          fechaAspas: 's',
                                          notaAlteracao: 'NR',
                                          rotulo: 'XV –',
                                          p: [
                                            {
                                              TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                              content: [
                                                '\n    instalação, ampliação ou atualização de redes destinadas à comunicação de voz e de dados e, em especial, de redes de alta velocidade que possibilitem o acesso à internet em escolas públicas, a fim de promover o acesso à inovação e à tecnologia nas escolas situadas em regiões de maior vulnerabilidade socioeconômica e de baixo desempenho em indicadores educacionais.\n  ',
                                              ],
                                            },
                                          ],
                                        },
