...
describe('buildJsonixFromProjetoNorma - Integração: Parser de medida provisória sem agrupador', () => {
  beforeEach(function () {
...
describe('buildJsonixFromProjetoNorma - Integração: Parser de medida provisória com agrupador', () => {
  beforeEach(function () {
  ...
  describe('Testando a transformação do model em jsonix', () => {
    ...
    it('Deveria apresentar 5 artigos abaixo da articulacao', () => {
      ...
      expect(jsonix.value.projetoNorma.norma.articulacao.lXhier.map((l: any) => l.name.flocalPart === 'Artigo').length).equals(5);
    });
