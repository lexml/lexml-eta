...
import { filtrarErrosLinksNomeAgrupador } from './buildJsonixHelpers';

describe('buildJsonixFromProjetoNorma - Assets Integration Tests', () => {
  const testarConversaoJsonix = (asset: any, nomeAsset: string, ignorarLinksNomeAgrupador = false): void => {
    ...
    // Filtrar erros relacionados a links em nomeAgrupador se solicitado
    const errosFiltrados = ignorarLinksNomeAgrupador ? filtrarErrosLinksNomeAgrupador(erros) : erros;
