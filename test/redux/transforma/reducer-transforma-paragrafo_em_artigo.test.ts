  ...
  describe('Testando a mudança do parágrafo 1, que não possui filhos, em artigo, quando o artigo anterior não possui incisos de caput', () => {
    ...
    describe('Testando os eventos resultantes da ação', () => {
      ...
      it('Deveria apresentar o parágrafo remanescente do artigo 1 e os artigos seguintes no array de elementos no evento de ElementoRenumerado', () => {
        ...
        expect(renumerado.elementos![0].conteudo?.texto).to.equal('Texto do parágrafo 2 do Artigo 1 que não possui incisos.');
  ...
  describe('Testando a mudança do parágrafo 2, que não possui filhos, em artigo, quando o artigo anterior não possui incisos de caput', () => {
    ...
    describe('Testando os eventos resultantes da ação', () => {
      ...
      it('Deveria apresentar os artigos seguintes no array de elementos no evento de ElementoRenumerado', () => {
        ...
        expect(renumerado.elementos!.length).equal(3);
        expect(renumerado.elementos![0].rotulo).equal('Parágrafo único.');
        expect(renumerado.elementos![0].conteudo?.texto).equal('Texto do parágrafo 1 do Artigo 1 que não possui incisos.');
        expect(renumerado.elementos![1].rotulo).equal('Art. 3º');
        expect(renumerado.elementos![1].conteudo?.texto).to.equal('Texto do caput do Artigo 2 que possui DOIS incisos e um parágrafo único:');
        expect(renumerado.elementos![2].rotulo).equal('Art. 4º');
        expect(renumerado.elementos![2].conteudo?.texto).to.equal('Texto do caput do artigo 3 que possui DOIS parágrafos sendo que o primeiro tem DOIS incisos.');
