...
import { transformarIncisoParagrafoEmParagrafo } from '../../../src/redux/elemento-actions';
...
describe('Testando a transformação de inciso em parágrafo', () => {
  ...
  describe('Testando a mudança de um único inciso em parágrafo único', () => {
    beforeEach(function () {
      ...
      const action = transformarIncisoParagrafoEmParagrafo.execute({ tipo: TipoDispositivo.inciso.tipo, uuid: inciso.uuid! });
