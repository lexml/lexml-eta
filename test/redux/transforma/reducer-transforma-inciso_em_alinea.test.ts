...
import { transformarIncisoCaputEmAlinea } from '../../../src/model/lexml/acoes/transformarElementoAction';
...
describe('Testando a transformação de inciso em alínea', () => {
  ...
  describe('Testando a mudança do segundo inciso, que não tem filhos, em alínea do primeiro', () => {
    beforeEach(function () {
      ...
      const action = transformarIncisoCaputEmAlinea.execute({ tipo: TipoDispositivo.inciso.tipo, uuid: inciso.uuid! });
