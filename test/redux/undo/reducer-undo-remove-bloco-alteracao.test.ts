    ...
    describe('Testando os eventos resultantes do undo da exclusão', () => {
      ...
      it('Deveria apresentar o artigo 3 no evento de ElementoRemoved', () => {
        expect(state.ui.events[0].elementos[0].conteudo.texto).equal(
          'A <a data-urn="urn:lex:br:federal:lei:1993-12-09;8745" class="lexml-remissao-externa" href="#" target="_self">Lei nº 8.745, de 9 de dezembro de 1993</a>, passa a vigorar com as seguintes alterações:'
        );
      });
