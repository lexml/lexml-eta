  ...
  value: {
    ...
    metadado: {
      ...
      identificacao: {
        ...
        urn: 'urn:lex:br:senado.federal:proposta.emenda.constitucional;pec:2023;00048',
      },
    },
    projetoNorma: {
      ...
      norma: {
        ...
        parteInicial: {
          ...
          epigrafe: {
            ...
            id: 'epigrafe',
            content: ['PROPOSTA DE EMENDA CONSTITUCIONAL Nº 00048 de 2023 '],
          },
          ementa: {
            TYPE_NAME: 'br_gov_lexml__1.GenInline',
            id: 'ementa',
            content: [
              'Altera o ',
              {
                ...
                value: {
                  TYPE_NAME: 'br_gov_lexml__1.GenInline',
                  href: 'urn:lex:br:federal:constituicao:1988-10-05;1988!art231_par1',
                  content: ['§1º do art. 231 da Constituição Federal'],
                },
              },
              ' para definir marco temporal de demarcação das terras tradicionalmente ocupadas pelos povos indígenas.  . \n',
            ],
          },
          preambulo: {
                      ...
                      p: [
                        {
                          ...
                          content: [
                            '\n    O ',
                            {
                              ...
                              value: {
                                TYPE_NAME: 'br_gov_lexml__1.GenInline',
                                href: 'urn:lex:br:federal:constituicao:1988-10-05;1988!art231',
                                content: ['art. 231 da Constituição Federal'],
                              },
                            },
