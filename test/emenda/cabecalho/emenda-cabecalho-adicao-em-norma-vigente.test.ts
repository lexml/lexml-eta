...
describe('Cabeçalho de comando de emenda com adição de dispositivos em alteração de norma vigente', () => {
  ...
  //   // expect(itemComandoEmenda.cabecalho).to.equal('Altere-se o art. 1º do Projeto para acrescentar art. 10 à Lei nº 11.340, de 7 de agosto de 2006, nos termos a seguir:');
  ...
  //     'Altere-se o art. 1º do Projeto para acrescentar § 5º ao art. 10 da Lei nº 11.340, de 7 de agosto de 2006, nos termos a seguir:'
  //   );
  // });
  ...
  //   const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandoEmenda().comandos[0];
  //   expect(itemComandoEmenda.cabecalho).to.equal(
  //     'Altere-se o art. 1º do Projeto para acrescentar parágrafo único ao art. 10 da Lei nº 11.340, de 7 de agosto de 2006, nos termos a seguir:'
  //   );
  // });
  ...
  //   const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandoEmenda().comandos[0];
  //   expect(itemComandoEmenda.cabecalho).to.equal(
  //     'Altere-se o art. 1º do Projeto para acrescentar inciso III ao caput do art. 10 da Lei nº 11.340, de 7 de agosto de 2006, nos termos a seguir:'
  //   );
  // });
  ...
  //   const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandoEmenda().comandos[0];
  //   expect(itemComandoEmenda.cabecalho).to.equal(
  //     'Altere-se o art. 1º do Projeto para acrescentar alínea “b” ao inciso I do § 2º do art. 10 da Lei nº 11.340, de 7 de agosto de 2006, nos termos a seguir:'
  //   );
  // });
  ...
  //   const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandoEmenda().comandos[0];
  //   expect(itemComandoEmenda.cabecalho).to.equal(
  //     'Altere-se o art. 6º do Projeto para acrescentar inciso IV ao caput do art. 1º da Lei nº 11.340, de 7 de agosto de 2006, nos termos a seguir:'
  //   );
  // });
});
