...
describe('Cabeçalho de comando de emenda com manipulação de omissis em alteração de norma vigente', () => {
  ...
  //     'Altere-se o caput do art. 6º do Projeto' +
  ...
  //   const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandoEmenda().comandos[0];
  //   expect(itemComandoEmenda.cabecalho).to.equal(
  //     'Suprima-se do caput do art. 6º do Projeto a linha pontilhada (omissis) após o inciso III do caput do art. 1º da Lei nº 11.340, de 7 de agosto de 2006.'
  //   );
  // });
  ...
  //   const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandoEmenda().comandos[0];
  //   expect(itemComandoEmenda.cabecalho).to.equal(
  //     'Suprima-se do caput do art. 6º do Projeto a linha pontilhada (omissis) antes do inciso III do caput do art. 1º da Lei nº 11.340, de 7 de agosto de 2006.'
  //   );
  // });
});
