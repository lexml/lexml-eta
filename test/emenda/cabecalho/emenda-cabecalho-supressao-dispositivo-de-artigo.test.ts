...
describe('Cabeçalho de comando de emenda com supressão de dispositivos de artigo', () => {
  beforeEach(function () {
  ...
  //     TesteCmdEmdUtil.suprimeDispositivo(state, "art1");
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Suprima-se o art. 1º; acrescente-se art. 4º-A; e dê-se nova redação ao caput do art. 9º"
  //                                 + " do Projeto, nos termos a seguir:");
  //   });
  ...
  //     TesteCmdEmdUtil.suprimeDispositivo(state, "art1");
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Suprima-se o art. 1º; e dê-se nova redação ao caput do art. 9º"
  //                         + " do Projeto, nos termos a seguir:");
  //   });
  ...
  //     TesteCmdEmdUtil.incluiParagrafo(state, "art9_par3", false);
  //     TesteCmdEmdUtil.incluiArtigo(state, "art9", false);
  //     TesteCmdEmdUtil.suprimeDispositivo(state, "art1");
  //     TesteCmdEmdUtil.suprimeDispositivo(state, "art9_par2");
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Suprimam-se o art. 1º e o § 2º do art. 9º;"
  ...
  //     TesteCmdEmdUtil.incluiArtigo(state, "art1", false);
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Acrescente-se art. 1º-A; suprima-se o art. 4º;"
  //                                 + " e dê-se nova redação ao § 7º do art. 9º do Projeto,"
  //                                 + " nos termos a seguir:");
  //   });
  ...
  //     TesteCmdEmdUtil.incluiArtigo(state, "art1", false);
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Acrescente-se art. 1º-A;"
  //                                 + " e dê-se nova redação ao § 7º do art. 9º do Projeto, nos termos a seguir:");
  //   });
  ...
  //     TesteCmdEmdUtil.incluiArtigo(state, "art1", false);
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Acrescente-se art. 1º-A; dê-se nova redação ao art. 4º;"
  //                                 + " e suprima-se o § 7º do art. 9º do Projeto, nos termos a seguir:");
  //   });
  ...
  //     TesteCmdEmdUtil.suprimeDispositivo(state, "art9_par7");
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Dê-se nova redação ao art. 4º;"
  //                                 + " e suprima-se o § 7º do art. 9º do Projeto, nos termos a seguir:");
  //   });
  ...
  //     TesteCmdEmdUtil.incluiParagrafo(state, "art8", false);
  //     TesteCmdEmdUtil.incluiArtigo(state, "art9", false);
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Dê-se nova redação ao caput do art. 2º e ao art. 4º;"
  ...
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Dê-se nova redação ao art. 4º;"
  //                         + " e acrescente-se art. 10 ao Projeto, nos termos a seguir:");
  //   });
  ...
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Dê-se nova redação ao art. 4º; acrescente-se art. 5º-A;"
  //                                 + " e suprima-se o § 7º do art. 9º do Projeto, nos termos a seguir:");
  //   });

  // it('modificacaoSupressaoDosParagrafosDeUmArtigo', () => throws IOException {
  //     inicializaArquivo("PLS_ERRO_PARAGRAFO_UNICO.xml");
  //     TesteCmdEmdUtil.modificaDispositivo(state, "art1_par1");
  //     TesteCmdEmdUtil.suprimeDispositivo(state, "art1_par2");
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Dê-se nova redação ao § 1º do art. 1º; e suprima-se o § 2º do art. 1º do Projeto,"
  //                         + " nos termos a seguir:");
  //   });
  ...
  //     const itemComandoEmenda = new ComandoEmendaBuilder(documento.urn!, state.articulacao!).getComandos()[0];
  //     expect(itemComandoEmenda.cabecalho).to.equal("Dê-se nova redação ao caput do art. 2º;"
  //                         + " e suprima-se o inciso II do caput do art. 2º do Projeto,"
  //                         + " nos termos a seguir:");
  //   });
});
